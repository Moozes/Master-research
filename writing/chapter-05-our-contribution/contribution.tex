...
\section{Dataset (MNIST- HAM10000)}
    ...
    The dataset has been collated and published by Tschandl, P., Rosendahl, C. \& Kittler, H.(7) A sample of each type of skin lesion present in the dataset is demonstrated in the figure ~\ref{fig:dataset}.(7) and the distribution of lesions is show in figure ~\ref{fig:distribution}

    \begin{figure}[htbp]
    \begin{center}
    \includegraphics[width=12cm]{./chapter-05-our-contribution/2.png}
    \end{center}
    \caption{A sample of each type of skin lesion \cite{}}
    \label{fig:dataset}
    \end{figure}
    ...
    \end{center}
    \caption{This count plot helps to understand the distribution of the data. \cite{}}
